    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-20">
        ...
        <section className="section-padding">
          <div className="container-narrow">
            <AnimatedSection>
              <h2 className="text-2xl md:text-3xl font-medium text-charcoal mb-6">La sfida</h2>
        ...
        <section className="section-padding bg-muted/30">
          <div className="container-narrow">
            <AnimatedSection>
              <h2 className="text-2xl md:text-3xl font-medium text-charcoal mb-12">Come abbiamo lavorato</h2>
            </AnimatedSection>
        ...
        <section className="section-padding">
          <div className="container-narrow">
            <AnimatedSection>
              <h2 className="text-2xl md:text-3xl font-medium text-charcoal mb-8">Risultati</h2>
