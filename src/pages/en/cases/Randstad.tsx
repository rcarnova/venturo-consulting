...
const RandstadEN = () => {
  return (
    <>
      <SEO
        title="Randstad: Employer Branding & Visible Culture"
        description="Employer branding case study: how Randstad Italia translated company culture into credible content through employees' voices."
